...
vex::motor LB(vex::PORT10, vex::gearSetting::ratio6_1, true); //Left Back Motor
vex::motor LM(vex::PORT9, vex::gearSetting::ratio6_1, true); //Left Middle Motor
...
vex::inertial InertialSensor(vex::PORT21);
